    ...
    <section>
      <header>
        ...
        <p className="mt-2 max-w-2xl text-sm text-zinc-400">
          Two or three sentences describing each concept and each player, shown
          at the top of their page. This is the text search engines read and
          visitors judge the page on — right now most of these pages are a
          heading over a grid of thumbnails.
        </p>
